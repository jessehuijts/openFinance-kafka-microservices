...
import org.openapitools.client.models.Error400PushAISASPSPAdditionalErrorsInner
...
/**
 * Standardised definition of reporting error information according to [RFC7807]  in case of a HTTP error code 400 for PushAIS (response from the ASPSP's server). 
 *
...
data class Error400PushAISASPSP (
    ...
    val additionalErrors: kotlin.collections.List<Error400PushAISASPSPAdditionalErrorsInner>? = null,
