...
import org.openapitools.client.models.AddSubscriptionEntryJson
import org.openapitools.client.models.AddSubscriptionEntryResponse
...
import org.openapitools.client.models.PushAccountInformationJson
//import org.openapitools.client.models.PushAccountInformationRequest
//import org.openapitools.client.models.PushAccountInformationRequest1
import org.openapitools.client.models.ReadSubscriptionDetailsResponse
import org.openapitools.client.models.ReadSubscriptionEntryDetailsResponse
import org.openapitools.client.models.ReadSubscriptionEntryStatusResponse
import org.openapitools.client.models.ReadSubscriptionStatusResponse
...
import org.openapitools.client.models.SubscriptionInitiationJson
import org.openapitools.client.models.SubscriptionInitiationResponse
...
class PushAccountInformationServiceApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
     ...
     */
     enum class PushAccountinformationSubserviceAddSubscriptionEntry(val value: kotlin.String) {
     ...
     */
     enum class PsUHttpMethodAddSubscriptionEntry(val value: kotlin.String) {
     ...
     * @param addSubscriptionEntryJson JSON request body for an add subscription entry request message. 
     ...
     * @param clientExplicitAuthorisationPreferred If it equals \&quot;true\&quot;, the TPP prefers to start the authorisation process separately,  e.g. because of the usage of a signing basket.  This preference might be ignored by the ASPSP, if a signing basket is not supported as functionality.  If it equals \&quot;false\&quot; or if the parameter is not used, there is no preference of the TPP.  This especially indicates that the TPP assumes a direct authorisation of the transaction in the next step,  without using a signing basket.  (optional)
     * @param clientBrandLoggingInformation This header might be used by TPPs to inform the ASPSP about the brand used by the TPP towards the PSU.  This information is meant for logging entries to enhance communication between ASPSP and PSU or ASPSP and TPP.  This header might be ignored by the ASPSP.  (optional)
     ...
     * @return AddSubscriptionEntryResponse
    ...
    fun addSubscriptionEntry(pushAccountinformationSubservice: PushAccountinformationSubserviceAddSubscriptionEntry, subscriptionId: kotlin.String, xRequestID: java.util.UUID, addSubscriptionEntryJson: AddSubscriptionEntryJson, tpPRedirectPreferred: kotlin.Boolean? = null, tpPRedirectURI: java.net.URI? = null, tpPNokRedirectURI: java.net.URI? = null, tpPDecoupledPreferred: kotlin.Boolean? = null, clientExplicitAuthorisationPreferred: kotlin.Boolean? = null, clientBrandLoggingInformation: kotlin.String? = null, PSU_ID: kotlin.String? = null, psUIDType: kotlin.String? = null, psUCorporateID: kotlin.String? = null, psUCorporateIDType: kotlin.String? = null, digest: kotlin.String? = null, signature: kotlin.String? = null, tpPSignatureCertificate: kotlin.ByteArray? = null, psUIPAddress: kotlin.String? = null, psUIPPort: kotlin.String? = null, psUAccept: kotlin.String? = null, psUAcceptCharset: kotlin.String? = null, psUAcceptEncoding: kotlin.String? = null, psUAcceptLanguage: kotlin.String? = null, psUUserAgent: kotlin.String? = null, psUHttpMethod: PsUHttpMethodAddSubscriptionEntry? = null, psUDeviceID: java.util.UUID? = null, psUGeoLocation: kotlin.String? = null) : AddSubscriptionEntryResponse {
        val localVarResponse = addSubscriptionEntryWithHttpInfo(pushAccountinformationSubservice = pushAccountinformationSubservice, subscriptionId = subscriptionId, xRequestID = xRequestID, addSubscriptionEntryJson = addSubscriptionEntryJson, tpPRedirectPreferred = tpPRedirectPreferred, tpPRedirectURI = tpPRedirectURI, tpPNokRedirectURI = tpPNokRedirectURI, tpPDecoupledPreferred = tpPDecoupledPreferred, clientExplicitAuthorisationPreferred = clientExplicitAuthorisationPreferred, clientBrandLoggingInformation = clientBrandLoggingInformation, PSU_ID = PSU_ID, psUIDType = psUIDType, psUCorporateID = psUCorporateID, psUCorporateIDType = psUCorporateIDType, digest = digest, signature = signature, tpPSignatureCertificate = tpPSignatureCertificate, psUIPAddress = psUIPAddress, psUIPPort = psUIPPort, psUAccept = psUAccept, psUAcceptCharset = psUAcceptCharset, psUAcceptEncoding = psUAcceptEncoding, psUAcceptLanguage = psUAcceptLanguage, psUUserAgent = psUUserAgent, psUHttpMethod = psUHttpMethod, psUDeviceID = psUDeviceID, psUGeoLocation = psUGeoLocation)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as AddSubscriptionEntryResponse
     ...
     * @param psUDeviceID UUID (Universally Unique Identifier) for a device, which is used by the PSU, if available. UUID identifies either a device or a device dependant application installation. In case of an installation identification this ID needs to be unaltered until removal from device.  (optional)
     * @param psUGeoLocation The forwarded Geo Location of the corresponding http request between PSU and TPP if available.  (optional)
     * @return ApiResponse<AddSubscriptionEntryResponse?>
     * @throws IllegalStateException If the request is not correctly configured
     * @throws IOException Rethrows the OkHttp execute method exception
     */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun addSubscriptionEntryWithHttpInfo(pushAccountinformationSubservice: PushAccountinformationSubserviceAddSubscriptionEntry, subscriptionId: kotlin.String, xRequestID: java.util.UUID, addSubscriptionEntryJson: AddSubscriptionEntryJson, tpPRedirectPreferred: kotlin.Boolean?, tpPRedirectURI: java.net.URI?, tpPNokRedirectURI: java.net.URI?, tpPDecoupledPreferred: kotlin.Boolean?, clientExplicitAuthorisationPreferred: kotlin.Boolean?, clientBrandLoggingInformation: kotlin.String?, PSU_ID: kotlin.String?, psUIDType: kotlin.String?, psUCorporateID: kotlin.String?, psUCorporateIDType: kotlin.String?, digest: kotlin.String?, signature: kotlin.String?, tpPSignatureCertificate: kotlin.ByteArray?, psUIPAddress: kotlin.String?, psUIPPort: kotlin.String?, psUAccept: kotlin.String?, psUAcceptCharset: kotlin.String?, psUAcceptEncoding: kotlin.String?, psUAcceptLanguage: kotlin.String?, psUUserAgent: kotlin.String?, psUHttpMethod: PsUHttpMethodAddSubscriptionEntry?, psUDeviceID: java.util.UUID?, psUGeoLocation: kotlin.String?) : ApiResponse<AddSubscriptionEntryResponse?> {
        val localVariableConfig = addSubscriptionEntryRequestConfig(pushAccountinformationSubservice = pushAccountinformationSubservice, subscriptionId = subscriptionId, xRequestID = xRequestID, addSubscriptionEntryJson = addSubscriptionEntryJson, tpPRedirectPreferred = tpPRedirectPreferred, tpPRedirectURI = tpPRedirectURI, tpPNokRedirectURI = tpPNokRedirectURI, tpPDecoupledPreferred = tpPDecoupledPreferred, clientExplicitAuthorisationPreferred = clientExplicitAuthorisationPreferred, clientBrandLoggingInformation = clientBrandLoggingInformation, PSU_ID = PSU_ID, psUIDType = psUIDType, psUCorporateID = psUCorporateID, psUCorporateIDType = psUCorporateIDType, digest = digest, signature = signature, tpPSignatureCertificate = tpPSignatureCertificate, psUIPAddress = psUIPAddress, psUIPPort = psUIPPort, psUAccept = psUAccept, psUAcceptCharset = psUAcceptCharset, psUAcceptEncoding = psUAcceptEncoding, psUAcceptLanguage = psUAcceptLanguage, psUUserAgent = psUUserAgent, psUHttpMethod = psUHttpMethod, psUDeviceID = psUDeviceID, psUGeoLocation = psUGeoLocation)

        return request<AddSubscriptionEntryJson, AddSubscriptionEntryResponse>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation addSubscriptionEntry
     *
     * @param pushAccountinformationSubservice push-accountinformation-subservice: The addressed subservice endpoint, e.g. for push-account-entries. The default list of sub services supported in this standard is: * push-account-entries * push-account-statements * push-balances * push-requests-to-pay 
     * @param subscriptionId subscriptionId as received in the body of a (positive) initiateSubscription response 
     * @param xRequestID ID of the request, unique to the call, as determined by the initiating party.
     ...
     */
    fun addSubscriptionEntryRequestConfig(pushAccountinformationSubservice: PushAccountinformationSubserviceAddSubscriptionEntry, subscriptionId: kotlin.String, xRequestID: java.util.UUID, addSubscriptionEntryJson: AddSubscriptionEntryJson, tpPRedirectPreferred: kotlin.Boolean?, tpPRedirectURI: java.net.URI?, tpPNokRedirectURI: java.net.URI?, tpPDecoupledPreferred: kotlin.Boolean?, clientExplicitAuthorisationPreferred: kotlin.Boolean?, clientBrandLoggingInformation: kotlin.String?, PSU_ID: kotlin.String?, psUIDType: kotlin.String?, psUCorporateID: kotlin.String?, psUCorporateIDType: kotlin.String?, digest: kotlin.String?, signature: kotlin.String?, tpPSignatureCertificate: kotlin.ByteArray?, psUIPAddress: kotlin.String?, psUIPPort: kotlin.String?, psUAccept: kotlin.String?, psUAcceptCharset: kotlin.String?, psUAcceptEncoding: kotlin.String?, psUAcceptLanguage: kotlin.String?, psUUserAgent: kotlin.String?, psUHttpMethod: PsUHttpMethodAddSubscriptionEntry?, psUDeviceID: java.util.UUID?, psUGeoLocation: kotlin.String?) : RequestConfig<AddSubscriptionEntryJson> {
        val localVariableBody = addSubscriptionEntryJson
        ...
        clientExplicitAuthorisationPreferred?.apply { localVariableHeaders["Client-Explicit-Authorisation-Preferred"] = this.toString() }
        clientBrandLoggingInformation?.apply { localVariableHeaders["Client-Brand-Logging-Information"] = this.toString() }
        ...
        return RequestConfig(
            ...
            path = "/subscriptions/{push-accountinformation-subservice}/{subscriptionId}/subscription-entries".replace("{"+"push-accountinformation-subservice"+"}", encodeURIComponent(pushAccountinformationSubservice.value.toString())).replace("{"+"subscriptionId"+"}", encodeURIComponent(subscriptionId.toString())),
     ...
     * enum for parameter pushAccountinformationSubservice
     */
     enum class PushAccountinformationSubserviceCancelSubscription(val value: kotlin.String) {
         @Json(name = "push-account-entries") accountMinusEntries("push-account-entries"),
         @Json(name = "push-account-statements") accountMinusStatements("push-account-statements"),
         @Json(name = "push-balances") balances("push-balances"),
         @Json(name = "push-requests-to-pay") requestsMinusToMinusPay("push-requests-to-pay")
     ...
     * enum for parameter psUHttpMethod
     */
     enum class PsUHttpMethodCancelSubscription(val value: kotlin.String) {
         @Json(name = "GET") GET("GET"),
         @Json(name = "POST") POST("POST"),
         @Json(name = "PUT") PUT("PUT"),
         @Json(name = "PATCH") PATCH("PATCH"),
     ...
     */
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun cancelSubscription(pushAccountinformationSubservice: PushAccountinformationSubserviceCancelSubscription, subscriptionId: kotlin.String, xRequestID: java.util.UUID, digest: kotlin.String? = null, signature: kotlin.String? = null, tpPSignatureCertificate: kotlin.ByteArray? = null, psUIPAddress: kotlin.String? = null, psUIPPort: kotlin.String? = null, psUAccept: kotlin.String? = null, psUAcceptCharset: kotlin.String? = null, psUAcceptEncoding: kotlin.String? = null, psUAcceptLanguage: kotlin.String? = null, psUUserAgent: kotlin.String? = null, psUHttpMethod: PsUHttpMethodCancelSubscription? = null, psUDeviceID: java.util.UUID? = null, psUGeoLocation: kotlin.String? = null) : Unit {
        val localVarResponse = cancelSubscriptionWithHttpInfo(pushAccountinformationSubservice = pushAccountinformationSubservice, subscriptionId = subscriptionId, xRequestID = xRequestID, digest = digest, signature = signature, tpPSignatureCertificate = tpPSignatureCertificate, psUIPAddress = psUIPAddress, psUIPPort = psUIPPort, psUAccept = psUAccept, psUAcceptCharset = psUAcceptCharset, psUAcceptEncoding = psUAcceptEncoding, psUAcceptLanguage = psUAcceptLanguage, psUUserAgent = psUUserAgent, psUHttpMethod = psUHttpMethod, psUDeviceID = psUDeviceID, psUGeoLocation = psUGeoLocation)
     ...
     */
    @Throws(IllegalStateException::class, IOException::class)
    fun cancelSubscriptionWithHttpInfo(pushAccountinformationSubservice: PushAccountinformationSubserviceCancelSubscription, subscriptionId: kotlin.String, xRequestID: java.util.UUID, digest: kotlin.String?, signature: kotlin.String?, tpPSignatureCertificate: kotlin.ByteArray?, psUIPAddress: kotlin.String?, psUIPPort: kotlin.String?, psUAccept: kotlin.String?, psUAcceptCharset: kotlin.String?, psUAcceptEncoding: kotlin.String?, psUAcceptLanguage: kotlin.String?, psUUserAgent: kotlin.String?, psUHttpMethod: PsUHttpMethodCancelSubscription?, psUDeviceID: java.util.UUID?, psUGeoLocation: kotlin.String?) : ApiResponse<Unit?> {
        val localVariableConfig = cancelSubscriptionRequestConfig(pushAccountinformationSubservice = pushAccountinformationSubservice, subscriptionId = subscriptionId, xRequestID = xRequestID, digest = digest, signature = signature, tpPSignatureCertificate = tpPSignatureCertificate, psUIPAddress = psUIPAddress, psUIPPort = psUIPPort, psUAccept = psUAccept, psUAcceptCharset = psUAcceptCharset, psUAcceptEncoding = psUAcceptEncoding, psUAcceptLanguage = psUAcceptLanguage, psUUserAgent = psUUserAgent, psUHttpMethod = psUHttpMethod, psUDeviceID = psUDeviceID, psUGeoLocation = psUGeoLocation)
     ...
     * @return RequestConfig
     */
    fun cancelSubscriptionRequestConfig(pushAccountinformationSubservice: PushAccountinformationSubserviceCancelSubscription, subscriptionId: kotlin.String, xRequestID: java.util.UUID, digest: kotlin.String?, signature: kotlin.String?, tpPSignatureCertificate: kotlin.ByteArray?, psUIPAddress: kotlin.String?, psUIPPort: kotlin.String?, psUAccept: kotlin.String?, psUAcceptCharset: kotlin.String?, psUAcceptEncoding: kotlin.String?, psUAcceptLanguage: kotlin.String?, psUUserAgent: kotlin.String?, psUHttpMethod: PsUHttpMethodCancelSubscription?, psUDeviceID: java.util.UUID?, psUGeoLocation: kotlin.String?) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/v1/subscriptions/{push-accountinformation-subservice}/{subscriptionId}".replace("{"+"push-accountinformation-subservice"+"}", encodeURIComponent(pushAccountinformationSubservice.value.toString())).replace("{"+"subscriptionId"+"}", encodeURIComponent(subscriptionId.toString())),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
            body = localVariableBody
     ...
     * enum for parameter pushAccountinformationSubservice
     */
     enum class PushAccountinformationSubserviceDeactivateSubscriptionEntry(val value: kotlin.String) {
         @Json(name = "push-account-entries") accountMinusEntries("push-account-entries"),
         @Json(name = "push-account-statements") accountMinusStatements("push-account-statements"),
         @Json(name = "push-balances") balances("push-balances"),
         @Json(name = "push-requests-to-pay") requestsMinusToMinusPay("push-requests-to-pay")
     ...
     * enum for parameter psUHttpMethod
     */
     enum class PsUHttpMethodDeactivateSubscriptionEntry(val value: kotlin.String) {
         @Json(name = "GET") GET("GET"),
         @Json(name = "POST") POST("POST"),
         @Json(name = "PUT") PUT("PUT"),
         @Json(name = "PATCH") PATCH("PATCH"),
     ...
     */
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun deactivateSubscriptionEntry(pushAccountinformationSubservice: PushAccountinformationSubserviceDeactivateSubscriptionEntry, subscriptionId: kotlin.String, subscriptionEntryId: kotlin.String, xRequestID: java.util.UUID, digest: kotlin.String? = null, signature: kotlin.String? = null, tpPSignatureCertificate: kotlin.ByteArray? = null, psUIPAddress: kotlin.String? = null, psUIPPort: kotlin.String? = null, psUAccept: kotlin.String? = null, psUAcceptCharset: kotlin.String? = null, psUAcceptEncoding: kotlin.String? = null, psUAcceptLanguage: kotlin.String? = null, psUUserAgent: kotlin.String? = null, psUHttpMethod: PsUHttpMethodDeactivateSubscriptionEntry? = null, psUDeviceID: java.util.UUID? = null, psUGeoLocation: kotlin.String? = null) : Unit {
        val localVarResponse = deactivateSubscriptionEntryWithHttpInfo(pushAccountinformationSubservice = pushAccountinformationSubservice, subscriptionId = subscriptionId, subscriptionEntryId = subscriptionEntryId, xRequestID = xRequestID, digest = digest, signature = signature, tpPSignatureCertificate = tpPSignatureCertificate, psUIPAddress = psUIPAddress, psUIPPort = psUIPPort, psUAccept = psUAccept, psUAcceptCharset = psUAcceptCharset, psUAcceptEncoding = psUAcceptEncoding, psUAcceptLanguage = psUAcceptLanguage, psUUserAgent = psUUserAgent, psUHttpMethod = psUHttpMethod, psUDeviceID = psUDeviceID, psUGeoLocation = psUGeoLocation)
     ...
     */
    @Throws(IllegalStateException::class, IOException::class)
    fun deactivateSubscriptionEntryWithHttpInfo(pushAccountinformationSubservice: PushAccountinformationSubserviceDeactivateSubscriptionEntry, subscriptionId: kotlin.String, subscriptionEntryId: kotlin.String, xRequestID: java.util.UUID, digest: kotlin.String?, signature: kotlin.String?, tpPSignatureCertificate: kotlin.ByteArray?, psUIPAddress: kotlin.String?, psUIPPort: kotlin.String?, psUAccept: kotlin.String?, psUAcceptCharset: kotlin.String?, psUAcceptEncoding: kotlin.String?, psUAcceptLanguage: kotlin.String?, psUUserAgent: kotlin.String?, psUHttpMethod: PsUHttpMethodDeactivateSubscriptionEntry?, psUDeviceID: java.util.UUID?, psUGeoLocation: kotlin.String?) : ApiResponse<Unit?> {
        val localVariableConfig = deactivateSubscriptionEntryRequestConfig(pushAccountinformationSubservice = pushAccountinformationSubservice, subscriptionId = subscriptionId, subscriptionEntryId = subscriptionEntryId, xRequestID = xRequestID, digest = digest, signature = signature, tpPSignatureCertificate = tpPSignatureCertificate, psUIPAddress = psUIPAddress, psUIPPort = psUIPPort, psUAccept = psUAccept, psUAcceptCharset = psUAcceptCharset, psUAcceptEncoding = psUAcceptEncoding, psUAcceptLanguage = psUAcceptLanguage, psUUserAgent = psUUserAgent, psUHttpMethod = psUHttpMethod, psUDeviceID = psUDeviceID, psUGeoLocation = psUGeoLocation)
    ...
    /**
     * To obtain the request config of the operation deactivateSubscriptionEntry
     *
     * @param pushAccountinformationSubservice push-accountinformation-subservice: The addressed subservice endpoint, e.g. for push-account-entries. The default list of sub services supported in this standard is: * push-account-entries * push-account-statements * push-balances * push-requests-to-pay 
     * @param subscriptionId subscriptionId as received in the body of a (positive) initiateSubscription response 
     * @param subscriptionEntryId subscriptionEntryId as received in the body of a (positive) initiateSubscription or addSubscriptionEntry response 
     ...
     * @return RequestConfig
     */
    fun deactivateSubscriptionEntryRequestConfig(pushAccountinformationSubservice: PushAccountinformationSubserviceDeactivateSubscriptionEntry, subscriptionId: kotlin.String, subscriptionEntryId: kotlin.String, xRequestID: java.util.UUID, digest: kotlin.String?, signature: kotlin.String?, tpPSignatureCertificate: kotlin.ByteArray?, psUIPAddress: kotlin.String?, psUIPPort: kotlin.String?, psUAccept: kotlin.String?, psUAcceptCharset: kotlin.String?, psUAcceptEncoding: kotlin.String?, psUAcceptLanguage: kotlin.String?, psUUserAgent: kotlin.String?, psUHttpMethod: PsUHttpMethodDeactivateSubscriptionEntry?, psUDeviceID: java.util.UUID?, psUGeoLocation: kotlin.String?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        xRequestID.apply { localVariableHeaders["X-Request-ID"] = this.toString() }
        ...
        return RequestConfig(
            method = RequestMethod.DELETE,
            path = "/v1/subscriptions/{push-accountinformation-subservice}/{subscriptionId}/subscription-entries/{subscriptionEntryId}".replace("{"+"push-accountinformation-subservice"+"}", encodeURIComponent(pushAccountinformationSubservice.value.toString())).replace("{"+"subscriptionId"+"}", encodeURIComponent(subscriptionId.toString())).replace("{"+"subscriptionEntryId"+"}", encodeURIComponent(subscriptionEntryId.toString())),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
            body = localVariableBody
     ...
     * enum for parameter pushAccountinformationSubservice
     */
     enum class PushAccountinformationSubserviceInitiateSubscription(val value: kotlin.String) {
         @Json(name = "push-account-entries") accountMinusEntries("push-account-entries"),
         @Json(name = "push-account-statements") accountMinusStatements("push-account-statements"),
         @Json(name = "push-balances") balances("push-balances"),
         @Json(name = "push-requests-to-pay") requestsMinusToMinusPay("push-requests-to-pay")
     ...
     * enum for parameter psUHttpMethod
     */
     enum class PsUHttpMethodInitiateSubscription(val value: kotlin.String) {
         @Json(name = "GET") GET("GET"),
         @Json(name = "POST") POST("POST"),
         @Json(name = "PUT") PUT("PUT"),
         @Json(name = "PATCH") PATCH("PATCH"),
     ...
     * @param pushAccountinformationSubservice push-accountinformation-subservice: The addressed subservice endpoint, e.g. for push-account-entries. The default list of sub services supported in this standard is: * push-account-entries * push-account-statements * push-balances * push-requests-to-pay 
     * @param xRequestID ID of the request, unique to the call, as determined by the initiating party.
     * @param psUIPAddress The forwarded IP Address header field consists of the corresponding http request IP Address field between PSU and TPP. If not available, the TPP shall use the IP Address used by the TPP when submitting this request. 
     * @param subscriptionInitiationJson JSON request body for a subscription initiation request message. 
     * @param digest Is contained if and only if the \&quot;Signature\&quot; element is contained in the header of the request. (optional)
     * @param signature A signature of the request by the TPP on application level. This might be mandated by ASPSP.  (optional)
     * @param tpPSignatureCertificate The certificate used for signing the request, in base64 encoding.  Must be contained if a signature is contained.  (optional)
     * @param clientBrandLoggingInformation This header might be used by TPPs to inform the ASPSP about the brand used by the TPP towards the PSU.  This information is meant for logging entries to enhance communication between ASPSP and PSU or ASPSP and TPP.  This header might be ignored by the ASPSP.  (optional)
     ...
     * @param contractID ID of the underlying service contract between API Client and ASPSP, resulting from API Client onboarding, following [oFA-OR-ADM].  Only applies where a contract is mandated by the ASPSP.  (optional)
     * @param psUIPPort The forwarded IP Port header field consists of the corresponding HTTP request IP Port field between PSU and TPP, if available.  (optional)
     * @param psUAccept The forwarded IP Accept header fields consist of the corresponding HTTP request Accept header fields between PSU and TPP, if available.  (optional)
     * @param psUAcceptCharset The forwarded IP Accept header fields consist of the corresponding HTTP request Accept header fields between PSU and TPP, if available.  (optional)
     * @param psUAcceptEncoding The forwarded IP Accept header fields consist of the corresponding HTTP request Accept header fields between PSU and TPP, if available.  (optional)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun initiateSubscription(pushAccountinformationSubservice: PushAccountinformationSubserviceInitiateSubscription, xRequestID: java.util.UUID, psUIPAddress: kotlin.String, subscriptionInitiationJson: SubscriptionInitiationJson, digest: kotlin.String? = null, signature: kotlin.String? = null, tpPSignatureCertificate: kotlin.ByteArray? = null, clientBrandLoggingInformation: kotlin.String? = null, PSU_ID: kotlin.String? = null, psUIDType: kotlin.String? = null, psUCorporateID: kotlin.String? = null, psUCorporateIDType: kotlin.String? = null, clientExplicitAuthorisationPreferred: kotlin.Boolean? = null, clientNotificationURI: kotlin.String? = null, clientNotificationContentPreferred: kotlin.String? = null, contractID: kotlin.String? = null, psUIPPort: kotlin.String? = null, psUAccept: kotlin.String? = null, psUAcceptCharset: kotlin.String? = null, psUAcceptEncoding: kotlin.String? = null, psUAcceptLanguage: kotlin.String? = null, psUUserAgent: kotlin.String? = null, psUHttpMethod: PsUHttpMethodInitiateSubscription? = null, psUDeviceID: java.util.UUID? = null, psUGeoLocation: kotlin.String? = null, tpPRedirectPreferred: kotlin.Boolean? = null, tpPRedirectURI: java.net.URI? = null, tpPNokRedirectURI: java.net.URI? = null, tpPDecoupledPreferred: kotlin.Boolean? = null) : SubscriptionInitiationResponse {
        val localVarResponse = initiateSubscriptionWithHttpInfo(pushAccountinformationSubservice = pushAccountinformationSubservice, xRequestID = xRequestID, psUIPAddress = psUIPAddress, subscriptionInitiationJson = subscriptionInitiationJson, digest = digest, signature = signature, tpPSignatureCertificate = tpPSignatureCertificate, clientBrandLoggingInformation = clientBrandLoggingInformation, PSU_ID = PSU_ID, psUIDType = psUIDType, psUCorporateID = psUCorporateID, psUCorporateIDType = psUCorporateIDType, clientExplicitAuthorisationPreferred = clientExplicitAuthorisationPreferred, clientNotificationURI = clientNotificationURI, clientNotificationContentPreferred = clientNotificationContentPreferred, contractID = contractID, psUIPPort = psUIPPort, psUAccept = psUAccept, psUAcceptCharset = psUAcceptCharset, psUAcceptEncoding = psUAcceptEncoding, psUAcceptLanguage = psUAcceptLanguage, psUUserAgent = psUUserAgent, psUHttpMethod = psUHttpMethod, psUDeviceID = psUDeviceID, psUGeoLocation = psUGeoLocation, tpPRedirectPreferred = tpPRedirectPreferred, tpPRedirectURI = tpPRedirectURI, tpPNokRedirectURI = tpPNokRedirectURI, tpPDecoupledPreferred = tpPDecoupledPreferred)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as SubscriptionInitiationResponse
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
     ...
     * @param tpPNokRedirectURI If this URI is contained, the TPP is asking to redirect the transaction flow to this address instead of the TPP-Redirect-URI in case of a negative result of the redirect SCA method. This might be ignored by the ASPSP.  (optional)
     * @param tpPDecoupledPreferred If it equals \&quot;true\&quot;, the TPP prefers a decoupled SCA approach.  If it equals \&quot;false\&quot;, the TPP prefers not to use the decoupled approach for SCA. The ASPSP will then choose between the embedded or the redirect SCA approach, depending on the choice of the SCA procedure by the TPP/PSU.  If the parameter is not used, the ASPSP will choose the SCA approach to be applied depending on the parameter TPP-Redirect-Preferred and the SCA method chosen by the TPP/PSU.  The parameter might be ignored by the ASPSP. If both parameters TPP-Redirect-Preferred and TPP-Decoupled-Preferred are present and true, the request is still not rejected, but it is up to the ASPSP, which approach will actually be used.  **Remark for Future:**  TPP-Redirect-Preferred and TPP-Decoupled-Preferred will be revised in future versions, maybe merged. Currently kept separate for downward compatibility.  (optional)
     * @return ApiResponse<SubscriptionInitiationResponse?>
     * @throws IllegalStateException If the request is not correctly configured
     * @throws IOException Rethrows the OkHttp execute method exception
     */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun initiateSubscriptionWithHttpInfo(pushAccountinformationSubservice: PushAccountinformationSubserviceInitiateSubscription, xRequestID: java.util.UUID, psUIPAddress: kotlin.String, subscriptionInitiationJson: SubscriptionInitiationJson, digest: kotlin.String?, signature: kotlin.String?, tpPSignatureCertificate: kotlin.ByteArray?, clientBrandLoggingInformation: kotlin.String?, PSU_ID: kotlin.String?, psUIDType: kotlin.String?, psUCorporateID: kotlin.String?, psUCorporateIDType: kotlin.String?, clientExplicitAuthorisationPreferred: kotlin.Boolean?, clientNotificationURI: kotlin.String?, clientNotificationContentPreferred: kotlin.String?, contractID: kotlin.String?, psUIPPort: kotlin.String?, psUAccept: kotlin.String?, psUAcceptCharset: kotlin.String?, psUAcceptEncoding: kotlin.String?, psUAcceptLanguage: kotlin.String?, psUUserAgent: kotlin.String?, psUHttpMethod: PsUHttpMethodInitiateSubscription?, psUDeviceID: java.util.UUID?, psUGeoLocation: kotlin.String?, tpPRedirectPreferred: kotlin.Boolean?, tpPRedirectURI: java.net.URI?, tpPNokRedirectURI: java.net.URI?, tpPDecoupledPreferred: kotlin.Boolean?) : ApiResponse<SubscriptionInitiationResponse?> {
        val localVariableConfig = initiateSubscriptionRequestConfig(pushAccountinformationSubservice = pushAccountinformationSubservice, xRequestID = xRequestID, psUIPAddress = psUIPAddress, subscriptionInitiationJson = subscriptionInitiationJson, digest = digest, signature = signature, tpPSignatureCertificate = tpPSignatureCertificate, clientBrandLoggingInformation = clientBrandLoggingInformation, PSU_ID = PSU_ID, psUIDType = psUIDType, psUCorporateID = psUCorporateID, psUCorporateIDType = psUCorporateIDType, clientExplicitAuthorisationPreferred = clientExplicitAuthorisationPreferred, clientNotificationURI = clientNotificationURI, clientNotificationContentPreferred = clientNotificationContentPreferred, contractID = contractID, psUIPPort = psUIPPort, psUAccept = psUAccept, psUAcceptCharset = psUAcceptCharset, psUAcceptEncoding = psUAcceptEncoding, psUAcceptLanguage = psUAcceptLanguage, psUUserAgent = psUUserAgent, psUHttpMethod = psUHttpMethod, psUDeviceID = psUDeviceID, psUGeoLocation = psUGeoLocation, tpPRedirectPreferred = tpPRedirectPreferred, tpPRedirectURI = tpPRedirectURI, tpPNokRedirectURI = tpPNokRedirectURI, tpPDecoupledPreferred = tpPDecoupledPreferred)

        return request<SubscriptionInitiationJson, SubscriptionInitiationResponse>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation initiateSubscription
     *
     * @param pushAccountinformationSubservice push-accountinformation-subservice: The addressed subservice endpoint, e.g. for push-account-entries. The default list of sub services supported in this standard is: * push-account-entries * push-account-statements * push-balances * push-requests-to-pay 
     * @param xRequestID ID of the request, unique to the call, as determined by the initiating party.
     * @param psUIPAddress The forwarded IP Address header field consists of the corresponding http request IP Address field between PSU and TPP. If not available, the TPP shall use the IP Address used by the TPP when submitting this request. 
     ...
     * @return RequestConfig
     */
    fun initiateSubscriptionRequestConfig(pushAccountinformationSubservice: PushAccountinformationSubserviceInitiateSubscription, xRequestID: java.util.UUID, psUIPAddress: kotlin.String, subscriptionInitiationJson: SubscriptionInitiationJson, digest: kotlin.String?, signature: kotlin.String?, tpPSignatureCertificate: kotlin.ByteArray?, clientBrandLoggingInformation: kotlin.String?, PSU_ID: kotlin.String?, psUIDType: kotlin.String?, psUCorporateID: kotlin.String?, psUCorporateIDType: kotlin.String?, clientExplicitAuthorisationPreferred: kotlin.Boolean?, clientNotificationURI: kotlin.String?, clientNotificationContentPreferred: kotlin.String?, contractID: kotlin.String?, psUIPPort: kotlin.String?, psUAccept: kotlin.String?, psUAcceptCharset: kotlin.String?, psUAcceptEncoding: kotlin.String?, psUAcceptLanguage: kotlin.String?, psUUserAgent: kotlin.String?, psUHttpMethod: PsUHttpMethodInitiateSubscription?, psUDeviceID: java.util.UUID?, psUGeoLocation: kotlin.String?, tpPRedirectPreferred: kotlin.Boolean?, tpPRedirectURI: java.net.URI?, tpPNokRedirectURI: java.net.URI?, tpPDecoupledPreferred: kotlin.Boolean?) : RequestConfig<SubscriptionInitiationJson> {
        val localVariableBody = subscriptionInitiationJson
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        xRequestID.apply { localVariableHeaders["X-Request-ID"] = this.toString() }
        psUIPAddress.apply { localVariableHeaders["PSU-IP-Address"] = this.toString() }
        ...
        contractID?.apply { localVariableHeaders["Contract-ID"] = this.toString() }
        psUIPPort?.apply { localVariableHeaders["PSU-IP-Port"] = this.toString() }
        psUAccept?.apply { localVariableHeaders["PSU-Accept"] = this.toString() }
        psUAcceptCharset?.apply { localVariableHeaders["PSU-Accept-Charset"] = this.toString() }
        psUAcceptEncoding?.apply { localVariableHeaders["PSU-Accept-Encoding"] = this.toString() }
        ...
        return RequestConfig(
            method = RequestMethod.POST,
            path = "/subscriptions/{push-accountinformation-subservice}".replace("{"+"push-accountinformation-subservice"+"}", encodeURIComponent(pushAccountinformationSubservice.value.toString())),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
            body = localVariableBody
     ...
     * enum for parameter pushAccountinformationSubservice
     */
     enum class PushAccountinformationSubservicePushAccountInformation(val value: kotlin.String) {
         @Json(name = "push-account-entries") accountMinusEntries("push-account-entries"),
         @Json(name = "push-account-statements") accountMinusStatements("push-account-statements"),
         @Json(name = "push-balances") balances("push-balances"),
         @Json(name = "push-requests-to-pay") requestsMinusToMinusPay("push-requests-to-pay")
     ...
     * @param pushAccountinformationSubservice push-accountinformation-subservice: The addressed subservice endpoint, e.g. for push-account-entries. The default list of sub services supported in this standard is: * push-account-entries * push-account-statements * push-balances * push-requests-to-pay 
     * @param xRequestID ID of the request, unique to the call, as determined by the initiating party.
     * @param pushAccountInformationJson Request body for a push account information request message. 
     * @return void
     * @throws IllegalStateException If the request is not correctly configured
     * @throws IOException Rethrows the OkHttp execute method exception
     * @throws UnsupportedOperationException If the API returns an informational or redirection response
     ...
     */
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun pushAccountInformation(pushAccountinformationSubservice: PushAccountinformationSubservicePushAccountInformation, xRequestID: java.util.UUID, pushAccountInformationJson: PushAccountInformationJson) : Unit {
        val localVarResponse = pushAccountInformationWithHttpInfo(pushAccountinformationSubservice = pushAccountinformationSubservice, xRequestID = xRequestID, pushAccountInformationJson = pushAccountInformationJson)
     ...
     */
    @Throws(IllegalStateException::class, IOException::class)
    fun pushAccountInformationWithHttpInfo(pushAccountinformationSubservice: PushAccountinformationSubservicePushAccountInformation, xRequestID: java.util.UUID, pushAccountInformationJson: PushAccountInformationJson) : ApiResponse<Unit?> {
        val localVariableConfig = pushAccountInformationRequestConfig(pushAccountinformationSubservice = pushAccountinformationSubservice, xRequestID = xRequestID, pushAccountInformationJson = pushAccountInformationJson)

        return request<PushAccountInformationJson, Unit>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation pushAccountInformation
     *
     * @param pushAccountinformationSubservice push-accountinformation-subservice: The addressed subservice endpoint, e.g. for push-account-entries. The default list of sub services supported in this standard is: * push-account-entries * push-account-statements * push-balances * push-requests-to-pay 
     * @param xRequestID ID of the request, unique to the call, as determined by the initiating party.
     * @param pushAccountInformationJson Request body for a push account information request message. 
     * @return RequestConfig
     */
    fun pushAccountInformationRequestConfig(pushAccountinformationSubservice: PushAccountinformationSubservicePushAccountInformation, xRequestID: java.util.UUID, pushAccountInformationJson: PushAccountInformationJson) : RequestConfig<PushAccountInformationJson> {
        val localVariableBody = pushAccountInformationJson
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        xRequestID.apply { localVariableHeaders["X-Request-ID"] = this.toString() }
        localVariableHeaders["Content-Type"] = "application/json"
        ...
        return RequestConfig(
            method = RequestMethod.POST,
            path = "/".replace("{"+"push-accountinformation-subservice"+"}", encodeURIComponent(pushAccountinformationSubservice.value.toString())),
            query = localVariableQuery,
            headers = localVariableHeaders,
     ...
     * enum for parameter pushAccountinformationSubservice
     */
     enum class PushAccountinformationSubserviceReadSubscriptionDetails(val value: kotlin.String) {
         @Json(name = "push-account-entries") accountMinusEntries("push-account-entries"),
         @Json(name = "push-account-statements") accountMinusStatements("push-account-statements"),
         @Json(name = "push-balances") balances("push-balances"),
         @Json(name = "push-requests-to-pay") requestsMinusToMinusPay("push-requests-to-pay")
     ...
     * enum for parameter psUHttpMethod
     */
     enum class PsUHttpMethodReadSubscriptionDetails(val value: kotlin.String) {
         @Json(name = "GET") GET("GET"),
         @Json(name = "POST") POST("POST"),
         @Json(name = "PUT") PUT("PUT"),
         @Json(name = "PATCH") PATCH("PATCH"),
     ...
     * @param psUDeviceID UUID (Universally Unique Identifier) for a device, which is used by the PSU, if available. UUID identifies either a device or a device dependant application installation. In case of an installation identification this ID needs to be unaltered until removal from device.  (optional)
     * @param psUGeoLocation The forwarded Geo Location of the corresponding http request between PSU and TPP if available.  (optional)
     * @return ReadSubscriptionDetailsResponse
     * @throws IllegalStateException If the request is not correctly configured
     * @throws IOException Rethrows the OkHttp execute method exception
     * @throws UnsupportedOperationException If the API returns an informational or redirection response
     * @throws ClientException If the API returns a client error response
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun readSubscriptionDetails(pushAccountinformationSubservice: PushAccountinformationSubserviceReadSubscriptionDetails, subscriptionId: kotlin.String, xRequestID: java.util.UUID, digest: kotlin.String? = null, signature: kotlin.String? = null, tpPSignatureCertificate: kotlin.ByteArray? = null, psUIPAddress: kotlin.String? = null, psUIPPort: kotlin.String? = null, psUAccept: kotlin.String? = null, psUAcceptCharset: kotlin.String? = null, psUAcceptEncoding: kotlin.String? = null, psUAcceptLanguage: kotlin.String? = null, psUUserAgent: kotlin.String? = null, psUHttpMethod: PsUHttpMethodReadSubscriptionDetails? = null, psUDeviceID: java.util.UUID? = null, psUGeoLocation: kotlin.String? = null) : ReadSubscriptionDetailsResponse {
        val localVarResponse = readSubscriptionDetailsWithHttpInfo(pushAccountinformationSubservice = pushAccountinformationSubservice, subscriptionId = subscriptionId, xRequestID = xRequestID, digest = digest, signature = signature, tpPSignatureCertificate = tpPSignatureCertificate, psUIPAddress = psUIPAddress, psUIPPort = psUIPPort, psUAccept = psUAccept, psUAcceptCharset = psUAcceptCharset, psUAcceptEncoding = psUAcceptEncoding, psUAcceptLanguage = psUAcceptLanguage, psUUserAgent = psUUserAgent, psUHttpMethod = psUHttpMethod, psUDeviceID = psUDeviceID, psUGeoLocation = psUGeoLocation)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as ReadSubscriptionDetailsResponse
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
     ...
     * @param psUDeviceID UUID (Universally Unique Identifier) for a device, which is used by the PSU, if available. UUID identifies either a device or a device dependant application installation. In case of an installation identification this ID needs to be unaltered until removal from device.  (optional)
     * @param psUGeoLocation The forwarded Geo Location of the corresponding http request between PSU and TPP if available.  (optional)
     * @return ApiResponse<ReadSubscriptionDetailsResponse?>
     * @throws IllegalStateException If the request is not correctly configured
     * @throws IOException Rethrows the OkHttp execute method exception
     */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun readSubscriptionDetailsWithHttpInfo(pushAccountinformationSubservice: PushAccountinformationSubserviceReadSubscriptionDetails, subscriptionId: kotlin.String, xRequestID: java.util.UUID, digest: kotlin.String?, signature: kotlin.String?, tpPSignatureCertificate: kotlin.ByteArray?, psUIPAddress: kotlin.String?, psUIPPort: kotlin.String?, psUAccept: kotlin.String?, psUAcceptCharset: kotlin.String?, psUAcceptEncoding: kotlin.String?, psUAcceptLanguage: kotlin.String?, psUUserAgent: kotlin.String?, psUHttpMethod: PsUHttpMethodReadSubscriptionDetails?, psUDeviceID: java.util.UUID?, psUGeoLocation: kotlin.String?) : ApiResponse<ReadSubscriptionDetailsResponse?> {
        val localVariableConfig = readSubscriptionDetailsRequestConfig(pushAccountinformationSubservice = pushAccountinformationSubservice, subscriptionId = subscriptionId, xRequestID = xRequestID, digest = digest, signature = signature, tpPSignatureCertificate = tpPSignatureCertificate, psUIPAddress = psUIPAddress, psUIPPort = psUIPPort, psUAccept = psUAccept, psUAcceptCharset = psUAcceptCharset, psUAcceptEncoding = psUAcceptEncoding, psUAcceptLanguage = psUAcceptLanguage, psUUserAgent = psUUserAgent, psUHttpMethod = psUHttpMethod, psUDeviceID = psUDeviceID, psUGeoLocation = psUGeoLocation)

        return request<Unit, ReadSubscriptionDetailsResponse>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation readSubscriptionDetails
     *
     * @param pushAccountinformationSubservice push-accountinformation-subservice: The addressed subservice endpoint, e.g. for push-account-entries. The default list of sub services supported in this standard is: * push-account-entries * push-account-statements * push-balances * push-requests-to-pay 
     * @param subscriptionId subscriptionId as received in the body of a (positive) initiateSubscription response 
     * @param xRequestID ID of the request, unique to the call, as determined by the initiating party.
     ...
     * @return RequestConfig
     */
    fun readSubscriptionDetailsRequestConfig(pushAccountinformationSubservice: PushAccountinformationSubserviceReadSubscriptionDetails, subscriptionId: kotlin.String, xRequestID: java.util.UUID, digest: kotlin.String?, signature: kotlin.String?, tpPSignatureCertificate: kotlin.ByteArray?, psUIPAddress: kotlin.String?, psUIPPort: kotlin.String?, psUAccept: kotlin.String?, psUAcceptCharset: kotlin.String?, psUAcceptEncoding: kotlin.String?, psUAcceptLanguage: kotlin.String?, psUUserAgent: kotlin.String?, psUHttpMethod: PsUHttpMethodReadSubscriptionDetails?, psUDeviceID: java.util.UUID?, psUGeoLocation: kotlin.String?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        xRequestID.apply { localVariableHeaders["X-Request-ID"] = this.toString() }
     ...
     * enum for parameter pushAccountinformationSubservice
     */
     enum class PushAccountinformationSubserviceReadSubscriptionEntryDetails(val value: kotlin.String) {
         @Json(name = "push-account-entries") accountMinusEntries("push-account-entries"),
         @Json(name = "push-account-statements") accountMinusStatements("push-account-statements"),
         @Json(name = "push-balances") balances("push-balances"),
         @Json(name = "push-requests-to-pay") requestsMinusToMinusPay("push-requests-to-pay")
     ...
     * enum for parameter psUHttpMethod
     */
     enum class PsUHttpMethodReadSubscriptionEntryDetails(val value: kotlin.String) {
         @Json(name = "GET") GET("GET"),
         @Json(name = "POST") POST("POST"),
         @Json(name = "PUT") PUT("PUT"),
         @Json(name = "PATCH") PATCH("PATCH"),
     ...
     * @param psUDeviceID UUID (Universally Unique Identifier) for a device, which is used by the PSU, if available. UUID identifies either a device or a device dependant application installation. In case of an installation identification this ID needs to be unaltered until removal from device.  (optional)
     * @param psUGeoLocation The forwarded Geo Location of the corresponding http request between PSU and TPP if available.  (optional)
     * @return ReadSubscriptionEntryDetailsResponse
     * @throws IllegalStateException If the request is not correctly configured
     * @throws IOException Rethrows the OkHttp execute method exception
     * @throws UnsupportedOperationException If the API returns an informational or redirection response
     * @throws ClientException If the API returns a client error response
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun readSubscriptionEntryDetails(pushAccountinformationSubservice: PushAccountinformationSubserviceReadSubscriptionEntryDetails, subscriptionId: kotlin.String, subscriptionEntryId: kotlin.String, xRequestID: java.util.UUID, digest: kotlin.String? = null, signature: kotlin.String? = null, tpPSignatureCertificate: kotlin.ByteArray? = null, psUIPAddress: kotlin.String? = null, psUIPPort: kotlin.String? = null, psUAccept: kotlin.String? = null, psUAcceptCharset: kotlin.String? = null, psUAcceptEncoding: kotlin.String? = null, psUAcceptLanguage: kotlin.String? = null, psUUserAgent: kotlin.String? = null, psUHttpMethod: PsUHttpMethodReadSubscriptionEntryDetails? = null, psUDeviceID: java.util.UUID? = null, psUGeoLocation: kotlin.String? = null) : ReadSubscriptionEntryDetailsResponse {
        val localVarResponse = readSubscriptionEntryDetailsWithHttpInfo(pushAccountinformationSubservice = pushAccountinformationSubservice, subscriptionId = subscriptionId, subscriptionEntryId = subscriptionEntryId, xRequestID = xRequestID, digest = digest, signature = signature, tpPSignatureCertificate = tpPSignatureCertificate, psUIPAddress = psUIPAddress, psUIPPort = psUIPPort, psUAccept = psUAccept, psUAcceptCharset = psUAcceptCharset, psUAcceptEncoding = psUAcceptEncoding, psUAcceptLanguage = psUAcceptLanguage, psUUserAgent = psUUserAgent, psUHttpMethod = psUHttpMethod, psUDeviceID = psUDeviceID, psUGeoLocation = psUGeoLocation)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as ReadSubscriptionEntryDetailsResponse
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
     ...
     * @param psUDeviceID UUID (Universally Unique Identifier) for a device, which is used by the PSU, if available. UUID identifies either a device or a device dependant application installation. In case of an installation identification this ID needs to be unaltered until removal from device.  (optional)
     * @param psUGeoLocation The forwarded Geo Location of the corresponding http request between PSU and TPP if available.  (optional)
     * @return ApiResponse<ReadSubscriptionEntryDetailsResponse?>
     * @throws IllegalStateException If the request is not correctly configured
     * @throws IOException Rethrows the OkHttp execute method exception
     */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun readSubscriptionEntryDetailsWithHttpInfo(pushAccountinformationSubservice: PushAccountinformationSubserviceReadSubscriptionEntryDetails, subscriptionId: kotlin.String, subscriptionEntryId: kotlin.String, xRequestID: java.util.UUID, digest: kotlin.String?, signature: kotlin.String?, tpPSignatureCertificate: kotlin.ByteArray?, psUIPAddress: kotlin.String?, psUIPPort: kotlin.String?, psUAccept: kotlin.String?, psUAcceptCharset: kotlin.String?, psUAcceptEncoding: kotlin.String?, psUAcceptLanguage: kotlin.String?, psUUserAgent: kotlin.String?, psUHttpMethod: PsUHttpMethodReadSubscriptionEntryDetails?, psUDeviceID: java.util.UUID?, psUGeoLocation: kotlin.String?) : ApiResponse<ReadSubscriptionEntryDetailsResponse?> {
        val localVariableConfig = readSubscriptionEntryDetailsRequestConfig(pushAccountinformationSubservice = pushAccountinformationSubservice, subscriptionId = subscriptionId, subscriptionEntryId = subscriptionEntryId, xRequestID = xRequestID, digest = digest, signature = signature, tpPSignatureCertificate = tpPSignatureCertificate, psUIPAddress = psUIPAddress, psUIPPort = psUIPPort, psUAccept = psUAccept, psUAcceptCharset = psUAcceptCharset, psUAcceptEncoding = psUAcceptEncoding, psUAcceptLanguage = psUAcceptLanguage, psUUserAgent = psUUserAgent, psUHttpMethod = psUHttpMethod, psUDeviceID = psUDeviceID, psUGeoLocation = psUGeoLocation)

        return request<Unit, ReadSubscriptionEntryDetailsResponse>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation readSubscriptionEntryDetails
     *
     * @param pushAccountinformationSubservice push-accountinformation-subservice: The addressed subservice endpoint, e.g. for push-account-entries. The default list of sub services supported in this standard is: * push-account-entries * push-account-statements * push-balances * push-requests-to-pay 
     * @param subscriptionId subscriptionId as received in the body of a (positive) initiateSubscription response 
     * @param subscriptionEntryId subscriptionEntryId as received in the body of a (positive) initiateSubscription or addSubscriptionEntry response 
     ...
     * @return RequestConfig
     */
    fun readSubscriptionEntryDetailsRequestConfig(pushAccountinformationSubservice: PushAccountinformationSubserviceReadSubscriptionEntryDetails, subscriptionId: kotlin.String, subscriptionEntryId: kotlin.String, xRequestID: java.util.UUID, digest: kotlin.String?, signature: kotlin.String?, tpPSignatureCertificate: kotlin.ByteArray?, psUIPAddress: kotlin.String?, psUIPPort: kotlin.String?, psUAccept: kotlin.String?, psUAcceptCharset: kotlin.String?, psUAcceptEncoding: kotlin.String?, psUAcceptLanguage: kotlin.String?, psUUserAgent: kotlin.String?, psUHttpMethod: PsUHttpMethodReadSubscriptionEntryDetails?, psUDeviceID: java.util.UUID?, psUGeoLocation: kotlin.String?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        xRequestID.apply { localVariableHeaders["X-Request-ID"] = this.toString() }
     ...
     * enum for parameter pushAccountinformationSubservice
     */
     enum class PushAccountinformationSubserviceReadSubscriptionEntryStatus(val value: kotlin.String) {
         @Json(name = "push-account-entries") accountMinusEntries("push-account-entries"),
         @Json(name = "push-account-statements") accountMinusStatements("push-account-statements"),
         @Json(name = "push-balances") balances("push-balances"),
         @Json(name = "push-requests-to-pay") requestsMinusToMinusPay("push-requests-to-pay")
     ...
     * enum for parameter psUHttpMethod
     */
     enum class PsUHttpMethodReadSubscriptionEntryStatus(val value: kotlin.String) {
         @Json(name = "GET") GET("GET"),
         @Json(name = "POST") POST("POST"),
         @Json(name = "PUT") PUT("PUT"),
         @Json(name = "PATCH") PATCH("PATCH"),
     ...
     * @param psUDeviceID UUID (Universally Unique Identifier) for a device, which is used by the PSU, if available. UUID identifies either a device or a device dependant application installation. In case of an installation identification this ID needs to be unaltered until removal from device.  (optional)
     * @param psUGeoLocation The forwarded Geo Location of the corresponding http request between PSU and TPP if available.  (optional)
     * @return ReadSubscriptionEntryStatusResponse
     * @throws IllegalStateException If the request is not correctly configured
     * @throws IOException Rethrows the OkHttp execute method exception
     * @throws UnsupportedOperationException If the API returns an informational or redirection response
     * @throws ClientException If the API returns a client error response
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun readSubscriptionEntryStatus(pushAccountinformationSubservice: PushAccountinformationSubserviceReadSubscriptionEntryStatus, subscriptionId: kotlin.String, subscriptionEntryId: kotlin.String, xRequestID: java.util.UUID, digest: kotlin.String? = null, signature: kotlin.String? = null, tpPSignatureCertificate: kotlin.ByteArray? = null, psUIPAddress: kotlin.String? = null, psUIPPort: kotlin.String? = null, psUAccept: kotlin.String? = null, psUAcceptCharset: kotlin.String? = null, psUAcceptEncoding: kotlin.String? = null, psUAcceptLanguage: kotlin.String? = null, psUUserAgent: kotlin.String? = null, psUHttpMethod: PsUHttpMethodReadSubscriptionEntryStatus? = null, psUDeviceID: java.util.UUID? = null, psUGeoLocation: kotlin.String? = null) : ReadSubscriptionEntryStatusResponse {
        val localVarResponse = readSubscriptionEntryStatusWithHttpInfo(pushAccountinformationSubservice = pushAccountinformationSubservice, subscriptionId = subscriptionId, subscriptionEntryId = subscriptionEntryId, xRequestID = xRequestID, digest = digest, signature = signature, tpPSignatureCertificate = tpPSignatureCertificate, psUIPAddress = psUIPAddress, psUIPPort = psUIPPort, psUAccept = psUAccept, psUAcceptCharset = psUAcceptCharset, psUAcceptEncoding = psUAcceptEncoding, psUAcceptLanguage = psUAcceptLanguage, psUUserAgent = psUUserAgent, psUHttpMethod = psUHttpMethod, psUDeviceID = psUDeviceID, psUGeoLocation = psUGeoLocation)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as ReadSubscriptionEntryStatusResponse
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
     ...
     * @param psUDeviceID UUID (Universally Unique Identifier) for a device, which is used by the PSU, if available. UUID identifies either a device or a device dependant application installation. In case of an installation identification this ID needs to be unaltered until removal from device.  (optional)
     * @param psUGeoLocation The forwarded Geo Location of the corresponding http request between PSU and TPP if available.  (optional)
     * @return ApiResponse<ReadSubscriptionEntryStatusResponse?>
     * @throws IllegalStateException If the request is not correctly configured
     * @throws IOException Rethrows the OkHttp execute method exception
     */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun readSubscriptionEntryStatusWithHttpInfo(pushAccountinformationSubservice: PushAccountinformationSubserviceReadSubscriptionEntryStatus, subscriptionId: kotlin.String, subscriptionEntryId: kotlin.String, xRequestID: java.util.UUID, digest: kotlin.String?, signature: kotlin.String?, tpPSignatureCertificate: kotlin.ByteArray?, psUIPAddress: kotlin.String?, psUIPPort: kotlin.String?, psUAccept: kotlin.String?, psUAcceptCharset: kotlin.String?, psUAcceptEncoding: kotlin.String?, psUAcceptLanguage: kotlin.String?, psUUserAgent: kotlin.String?, psUHttpMethod: PsUHttpMethodReadSubscriptionEntryStatus?, psUDeviceID: java.util.UUID?, psUGeoLocation: kotlin.String?) : ApiResponse<ReadSubscriptionEntryStatusResponse?> {
        val localVariableConfig = readSubscriptionEntryStatusRequestConfig(pushAccountinformationSubservice = pushAccountinformationSubservice, subscriptionId = subscriptionId, subscriptionEntryId = subscriptionEntryId, xRequestID = xRequestID, digest = digest, signature = signature, tpPSignatureCertificate = tpPSignatureCertificate, psUIPAddress = psUIPAddress, psUIPPort = psUIPPort, psUAccept = psUAccept, psUAcceptCharset = psUAcceptCharset, psUAcceptEncoding = psUAcceptEncoding, psUAcceptLanguage = psUAcceptLanguage, psUUserAgent = psUUserAgent, psUHttpMethod = psUHttpMethod, psUDeviceID = psUDeviceID, psUGeoLocation = psUGeoLocation)

        return request<Unit, ReadSubscriptionEntryStatusResponse>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation readSubscriptionEntryStatus
     *
     * @param pushAccountinformationSubservice push-accountinformation-subservice: The addressed subservice endpoint, e.g. for push-account-entries. The default list of sub services supported in this standard is: * push-account-entries * push-account-statements * push-balances * push-requests-to-pay 
     * @param subscriptionId subscriptionId as received in the body of a (positive) initiateSubscription response 
     * @param subscriptionEntryId subscriptionEntryId as received in the body of a (positive) initiateSubscription or addSubscriptionEntry response 
     ...
     * @return RequestConfig
     */
    fun readSubscriptionEntryStatusRequestConfig(pushAccountinformationSubservice: PushAccountinformationSubserviceReadSubscriptionEntryStatus, subscriptionId: kotlin.String, subscriptionEntryId: kotlin.String, xRequestID: java.util.UUID, digest: kotlin.String?, signature: kotlin.String?, tpPSignatureCertificate: kotlin.ByteArray?, psUIPAddress: kotlin.String?, psUIPPort: kotlin.String?, psUAccept: kotlin.String?, psUAcceptCharset: kotlin.String?, psUAcceptEncoding: kotlin.String?, psUAcceptLanguage: kotlin.String?, psUUserAgent: kotlin.String?, psUHttpMethod: PsUHttpMethodReadSubscriptionEntryStatus?, psUDeviceID: java.util.UUID?, psUGeoLocation: kotlin.String?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        xRequestID.apply { localVariableHeaders["X-Request-ID"] = this.toString() }
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/v1/subscriptions/{push-accountinformation-subservice}/{subscriptionId}/subscription-entries/{subscriptionEntryId}/status".replace("{"+"push-accountinformation-subservice"+"}", encodeURIComponent(pushAccountinformationSubservice.value.toString())).replace("{"+"subscriptionId"+"}", encodeURIComponent(subscriptionId.toString())).replace("{"+"subscriptionEntryId"+"}", encodeURIComponent(subscriptionEntryId.toString())),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
            body = localVariableBody
     ...
     * enum for parameter pushAccountinformationSubservice
     */
     enum class PushAccountinformationSubserviceReadSubscriptionStatus(val value: kotlin.String) {
         @Json(name = "push-account-entries") accountMinusEntries("push-account-entries"),
         @Json(name = "push-account-statements") accountMinusStatements("push-account-statements"),
         @Json(name = "push-balances") balances("push-balances"),
         @Json(name = "push-requests-to-pay") requestsMinusToMinusPay("push-requests-to-pay")
     ...
     * enum for parameter psUHttpMethod
     */
     enum class PsUHttpMethodReadSubscriptionStatus(val value: kotlin.String) {
         @Json(name = "GET") GET("GET"),
         @Json(name = "POST") POST("POST"),
         @Json(name = "PUT") PUT("PUT"),
         @Json(name = "PATCH") PATCH("PATCH"),
     ...
     * @param psUDeviceID UUID (Universally Unique Identifier) for a device, which is used by the PSU, if available. UUID identifies either a device or a device dependant application installation. In case of an installation identification this ID needs to be unaltered until removal from device.  (optional)
     * @param psUGeoLocation The forwarded Geo Location of the corresponding http request between PSU and TPP if available.  (optional)
     * @return ReadSubscriptionStatusResponse
     * @throws IllegalStateException If the request is not correctly configured
     * @throws IOException Rethrows the OkHttp execute method exception
     * @throws UnsupportedOperationException If the API returns an informational or redirection response
     * @throws ClientException If the API returns a client error response
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun readSubscriptionStatus(pushAccountinformationSubservice: PushAccountinformationSubserviceReadSubscriptionStatus, subscriptionId: kotlin.String, xRequestID: java.util.UUID, digest: kotlin.String? = null, signature: kotlin.String? = null, tpPSignatureCertificate: kotlin.ByteArray? = null, psUIPAddress: kotlin.String? = null, psUIPPort: kotlin.String? = null, psUAccept: kotlin.String? = null, psUAcceptCharset: kotlin.String? = null, psUAcceptEncoding: kotlin.String? = null, psUAcceptLanguage: kotlin.String? = null, psUUserAgent: kotlin.String? = null, psUHttpMethod: PsUHttpMethodReadSubscriptionStatus? = null, psUDeviceID: java.util.UUID? = null, psUGeoLocation: kotlin.String? = null) : ReadSubscriptionStatusResponse {
        val localVarResponse = readSubscriptionStatusWithHttpInfo(pushAccountinformationSubservice = pushAccountinformationSubservice, subscriptionId = subscriptionId, xRequestID = xRequestID, digest = digest, signature = signature, tpPSignatureCertificate = tpPSignatureCertificate, psUIPAddress = psUIPAddress, psUIPPort = psUIPPort, psUAccept = psUAccept, psUAcceptCharset = psUAcceptCharset, psUAcceptEncoding = psUAcceptEncoding, psUAcceptLanguage = psUAcceptLanguage, psUUserAgent = psUUserAgent, psUHttpMethod = psUHttpMethod, psUDeviceID = psUDeviceID, psUGeoLocation = psUGeoLocation)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as ReadSubscriptionStatusResponse
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
     ...
     * @param psUDeviceID UUID (Universally Unique Identifier) for a device, which is used by the PSU, if available. UUID identifies either a device or a device dependant application installation. In case of an installation identification this ID needs to be unaltered until removal from device.  (optional)
     * @param psUGeoLocation The forwarded Geo Location of the corresponding http request between PSU and TPP if available.  (optional)
     * @return ApiResponse<ReadSubscriptionStatusResponse?>
     * @throws IllegalStateException If the request is not correctly configured
     * @throws IOException Rethrows the OkHttp execute method exception
     */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun readSubscriptionStatusWithHttpInfo(pushAccountinformationSubservice: PushAccountinformationSubserviceReadSubscriptionStatus, subscriptionId: kotlin.String, xRequestID: java.util.UUID, digest: kotlin.String?, signature: kotlin.String?, tpPSignatureCertificate: kotlin.ByteArray?, psUIPAddress: kotlin.String?, psUIPPort: kotlin.String?, psUAccept: kotlin.String?, psUAcceptCharset: kotlin.String?, psUAcceptEncoding: kotlin.String?, psUAcceptLanguage: kotlin.String?, psUUserAgent: kotlin.String?, psUHttpMethod: PsUHttpMethodReadSubscriptionStatus?, psUDeviceID: java.util.UUID?, psUGeoLocation: kotlin.String?) : ApiResponse<ReadSubscriptionStatusResponse?> {
        val localVariableConfig = readSubscriptionStatusRequestConfig(pushAccountinformationSubservice = pushAccountinformationSubservice, subscriptionId = subscriptionId, xRequestID = xRequestID, digest = digest, signature = signature, tpPSignatureCertificate = tpPSignatureCertificate, psUIPAddress = psUIPAddress, psUIPPort = psUIPPort, psUAccept = psUAccept, psUAcceptCharset = psUAcceptCharset, psUAcceptEncoding = psUAcceptEncoding, psUAcceptLanguage = psUAcceptLanguage, psUUserAgent = psUUserAgent, psUHttpMethod = psUHttpMethod, psUDeviceID = psUDeviceID, psUGeoLocation = psUGeoLocation)

        return request<Unit, ReadSubscriptionStatusResponse>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation readSubscriptionStatus
     *
     * @param pushAccountinformationSubservice push-accountinformation-subservice: The addressed subservice endpoint, e.g. for push-account-entries. The default list of sub services supported in this standard is: * push-account-entries * push-account-statements * push-balances * push-requests-to-pay 
     * @param subscriptionId subscriptionId as received in the body of a (positive) initiateSubscription response 
     * @param xRequestID ID of the request, unique to the call, as determined by the initiating party.
     ...
     * @return RequestConfig
     */
    fun readSubscriptionStatusRequestConfig(pushAccountinformationSubservice: PushAccountinformationSubserviceReadSubscriptionStatus, subscriptionId: kotlin.String, xRequestID: java.util.UUID, digest: kotlin.String?, signature: kotlin.String?, tpPSignatureCertificate: kotlin.ByteArray?, psUIPAddress: kotlin.String?, psUIPPort: kotlin.String?, psUAccept: kotlin.String?, psUAcceptCharset: kotlin.String?, psUAcceptEncoding: kotlin.String?, psUAcceptLanguage: kotlin.String?, psUUserAgent: kotlin.String?, psUHttpMethod: PsUHttpMethodReadSubscriptionStatus?, psUDeviceID: java.util.UUID?, psUGeoLocation: kotlin.String?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        xRequestID.apply { localVariableHeaders["X-Request-ID"] = this.toString() }
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/v1/subscriptions/{push-accountinformation-subservice}/{subscriptionId}/status".replace("{"+"push-accountinformation-subservice"+"}", encodeURIComponent(pushAccountinformationSubservice.value.toString())).replace("{"+"subscriptionId"+"}", encodeURIComponent(subscriptionId.toString())),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
            body = localVariableBody
