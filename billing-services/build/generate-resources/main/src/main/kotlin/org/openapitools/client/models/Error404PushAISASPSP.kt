...
import org.openapitools.client.models.Error404PushAISASPSPAdditionalErrorsInner
...
/**
 * Standardised definition of reporting error information according to [RFC7807]  in case of a HTTP error code 404 for PushAIS (from the ASPSP's server). 
 *
...
data class Error404PushAISASPSP (
    ...
    val additionalErrors: kotlin.collections.List<Error404PushAISASPSPAdditionalErrorsInner>? = null,
